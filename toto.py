...
########################################################################################################################
def gauss_fft_fwm(delta_dsw_input):

    delta_rho = np.reshape(delta_dsw_input, (L, N, M))
...
result = gauss_fft_fwm(delta_rho)
np.savetxt('without_grid_expansion_FFT.txt', result, delimiter=' ', header='')
########################################################################################################################
slice_index = 0
